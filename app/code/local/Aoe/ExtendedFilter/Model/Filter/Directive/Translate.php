...
/**
 * Class Aoe_ExtendedFilter_Model_Filter_Directive_Translate
 *
 * @author Lee Saferite <lee.saferite@aoe.com>
 */
class Aoe_ExtendedFilter_Model_Filter_Directive_Translate implements Aoe_ExtendedFilter_Model_Filter_Directive_Interface
{
    /**
