...
/**
 * Class Aoe_ExtendedFilter_Model_Core
 *
 * @author Lee Saferite <lee.saferite@aoe.com>
 */
class Aoe_ExtendedFilter_Model_Core extends Mage_Core_Model_Email_Template_Filter implements Aoe_ExtendedFilter_Model_Interface
{
